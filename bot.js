...
const TRANSLATE_URL = `https://${AZURE_REGION}.api.cognitive.microsofttranslator.com/translate?api-version=3.0&to=es,it&textType=plain&profanityAction=NoAction`;
